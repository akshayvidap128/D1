            ...
            <div class="col-md-12 mt-4">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Stitching Payment</h4>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                        ...
                        <table id="Table"class="table table-bordered">
                            ...
                            if(isset($_POST['search_by_name']))
                            {
                                ...
                                $to=$_POST['to_date'];
                                $query="SELECT * FROM format WHERE TDATE BETWEEN '$from' AND '$to' AND EMP='$name'";
                            ...
                            ?>
                                ...
                                <tr>
                                   ...
                                   <!-- <td><input type="text" disabled value="<?php echo $row['EMP']; ?>"></td>-->
                                    ...
                                    <td><input type="text" id="tquantity" value="<?php echo $row['TQUANTITY']; ?>"></td>
                                    <td><input type="text" id="price"  value="<?php echo $row['PRICE']; ?>"></td>
                                    <td><input type="text" id="totalvalue" value="<?php echo $row['TOTALVALUE']; ?>"></td>
                            ...
                            <tfoot align="">
                                ...
                                $querys="SELECT sum(TQUANTITY) FROM format WHERE TDATE BETWEEN '$from' AND '$to' AND EMP='$name'";
                               ...
                               <!-- <td colspan="6"align="right"><input type="text" disabled value="<?php echo $rows['sum(TOTALVALUE)']; ?>"></td>-->
                                ...
                                $querys="SELECT sum(TOTALVALUE) FROM format WHERE TDATE BETWEEN '$from' AND '$to' AND EMP='$name'";
                                $results = mysqli_query($connection,$querys) or die(mysqli_error());
                                while($rows = mysqli_fetch_array($results)){?>
                                 <td colspan="6"align="right"><input type="text" disabled value="<?php echo $rows['sum(TOTALVALUE)']; ?>"></td>
