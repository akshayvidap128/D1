...
<meta charset="UTF-8">
    ...
    <title>Partywise Stitching Report</title>
            ...
            <div class="col-md-12 mt-4">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Partywise Stitching Report</h4>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                        ...
                        <table id="Table"class="table table-bordered">
                            ...
                            {
                                $name=$_POST['emp_name'];
                                $query="SELECT * FROM format WHERE PARTYNAME='$name'";
                            ...
                            <tfoot align="">
                                ...
                                $querys="SELECT sum(QUANTITY) FROM format WHERE PARTYNAME='$name'";
