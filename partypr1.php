...
<meta charset="UTF-8">
    ...
    <title>Partywise Press Report</title>
            ...
            <div class="col-md-12 mt-4">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Partywise Press Report</h4>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                        ...
                        <table id="Table"class="table table-bordered">
                            ...
                            {
                                $name=$_POST['emp_name'];
                                $query="SELECT * FROM payment WHERE EMP='$name'";
                            ...
                            ?>
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" disabled value="<?php echo $row['TOTAL']; ?>"></td>
                            ...
                            <tfoot align="">
                                ...
                                $querys="SELECT sum(QUANTITY) FROM payment WHERE EMP='$name'";
                                $results = mysqli_query($connection,$querys) or die(mysqli_error());
                                while($rows = mysqli_fetch_array($results)){?>
                                 <td colspan="2"align=""><input type="text" disabled value="<?php echo $rows['sum(QUANTITY)']; ?>"></td>
                                ...
                                $querys="SELECT sum(TOTAL) FROM payment WHERE EMP='$name'";
                                $results = mysqli_query($connection,$querys) or die(mysqli_error());
                                while($rows = mysqli_fetch_array($results)){?>
                                 <td colspan="4"align=""><input type="text" disabled value="<?php echo $rows['sum(TOTAL)']; ?>"></td>
