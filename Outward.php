...
<meta charset="UTF-8">
    ...
    <title>Stitching Outward Entry</title>
...
<form method="post">
    ...
    <tr>
        ...
        <td>
            <input class="input100" type="Text" name= "givername" required></td>
    </tr>
    <tr>
        <td></td>
        <td><br>
...
if(isset($_POST['submit']))
{
    ...
    $q1=$_POST['quantity'];
    $g1=$_POST['givername'];
    $query="INSERT INTO format(DATE,id,PERTICULAR,PARTYNAME,EMP,QUANTITY,GIVERNAME) VALUES('$d1','$b1','$p1','$l1','$e1','$q1','$g1')";
